            ...
            <form className='text-start'>
              ...
              <div className='border border-dark border-2 textAreaBox mt-4 telephoneNumbers'>
                <div className="input-group input-group-lg">
                  <textarea id='phonesTextArea' placeholder='Pon tu mensaje aquí' style={{ border: "none", outline: "none", width: "100%" }} className="p-2 textAreaBox" rows={5} value={messageBody} onChange={(event) => setMessageBody(event.target.value)}></textarea>
                </div>
              </div>
            </form>
