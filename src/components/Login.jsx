        ...
        <div className='row justify-content-center mt-5'>
            <div className='col-4'>
                ...
                <div className='text-center d-grid gap-2 mt-3'>
                    <button className="btn btn-outline-secondary text-black  " onClick={handleGoogleSignin}><img className='me-3 pb-1' alt="google-logo" src="https://img.icons8.com/color/16/000000/google-logo.png" />Inicia sesión con Google</button>
                </div>
                <div className='text-center d-grid gap-2 mt-3'>
